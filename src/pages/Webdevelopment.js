        ...
        <div className='w-full h-full'>
            ...
            <motion.div
                ...
                <div className='col-span-4'>
                    ...
                    <p>
                    Diseñamos un sitio web como Landingpage (Nav-Home-About-Catálogo-Contact-Map-Footer
                    con lenguajes de programación HTML-CSS-JS) o ReacApp (aplicación desarrollada y 
                    ...
                    (carpeta del sitio) en Github y lo vinculamos con Vercel que es un servicio de 
                    alojamiento gratuito (tu-marca.vercel.app) o adquirimos un DNS personalizado 
                    (www.tu-marca.com). También te ofrecemos el certificado de seguridad (SSL) para 
                    que el ingreso a tu web sea bajo el protocolo HTTPS (https://www.tu-marca.com).

                    <br/>
                    El último paso sería crear un correo empresarial (ventas@tu-marca.com), vincularlo
                    con el sitio web para informar a tus suscriptores sobre novedades o hacer Email 
                    Marketing con promociones sobre tu marca.
